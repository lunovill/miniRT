...
// 	data->c->coor = (Tuple4f){0.0, 0.0, 0.0, 1.0};
// 	data->c->vector = (Tuple4f){0.0, 0.0, 1.0, 0.0};
...
// 	data->l[0]->color = (Tuple4f){0.5, 255.0, 255.0, 255.0};
// 	// Lumiere Verte
// 	data->l[1] = malloc(sizeof(t_light));
// 	data->garbage = gbg_add(data->garbage, data->l[1]);
// 	data->l[1]->coor = (Tuple4f){0.0, 0.0, 100.0};
// 	data->l[1]->color = (Tuple4f){0.6, 255.0, 255.0, 255.0};
// 	// // Lumiere Rouge
// 	// data->l[2] = malloc(sizeof(t_light));
// 	// data->garbage = gbg_add(data->garbage, data->l[2]);
// 	// data->l[2]->coor = (Tuple4f){50.0, -50.0, 25.0};
// 	// data->l[2]->color = (Tuple4f){0.6, 255.0, 0.0, 0.0};
// 	// // Lumiere Blanche
// 	// data->l[3] = malloc(sizeof(t_light));
// 	// data->garbage = gbg_add(data->garbage, data->l[3]);
// 	// data->l[3]->coor = (Tuple4f){0.0, 0.0, 500.0};
// 	// data->l[3]->color = (Tuple4f){0.5, 255.0, 255.0, 255.0};
// 	data->l[2] = NULL;
// 	// Plan
...
// 	data->pl[0]->coor = (Tuple4f){0.0, -100.0, -100.0, 1.0};
// 	data->pl[0]->vector = (Tuple4f){0.0, 1.0, 0.0, 0.0};
// 	data->pl[0]->color = (Tuple4f){1.0, 255.0, 255.0, 255.0};
// 	data->pl[1] = NULL;
// 	// Sphere 0
